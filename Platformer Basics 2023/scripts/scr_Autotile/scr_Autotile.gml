...
function scr_AutoTile(_tile) {
	...
	with(_tile)
	{
	    ...
	    if (position_meeting(x,              y - img_height, obj_block))  u = 1;
	    if (position_meeting(x + img_width,  y,              obj_block))  r = 2;
	    if (position_meeting(x,              y + img_height, obj_block))  d = 4;
	    if (position_meeting(x - img_width,  y,              obj_block))  l = 8;
    
	    // Check corner existence
	    if (position_meeting(x - img_height, y - img_width,  obj_block))  ul = 1;
	    if (position_meeting(x + img_height, y - img_width,  obj_block))  ur = 2;
	    if (position_meeting(x + img_height, y + img_width,  obj_block))  dr = 4;
	    if (position_meeting(x - img_height, y + img_width,  obj_block))  dl = 8;
